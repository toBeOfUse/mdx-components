...
export function MdxExample({ component, mdx, attrs }: { component: string; mdx: string; attrs?: string }) {
  ...
  useEffect(() => { compile(fullSource) }, [fullSource, compile])

  return (
    <div className="mdx-example" style={{
      ...
      <div style={{
        ...
        {error ? (
          ...
          <ErrorBoundary resetKey={fullSource}>
            {result}
          </ErrorBoundary>
        )}
      </div>
